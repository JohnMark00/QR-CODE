...
<html lang="en-US">
	...
	<body onload="startTime()">
		...
		<div class="myoutput">
			<h3><strong>Document QR Code Generator</strong></h3>
			<div class="input-field">
				...
				<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" >
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" name="subject" style="width:20em;" placeholder="Document Name" value="<?php echo @$subject; ?>" required pattern="[a-zA-Z .]+" />
					</div>

					<div class="form-group">
						<label>Description</label>
						<input type="text" class="form-control" name="descr" style="width:20em;" value="<?php echo @$body; ?>" required pattern="[a-zA-Z0-9 .]+" placeholder="Description"></textarea>
					</div>
					<div class="form-group">
