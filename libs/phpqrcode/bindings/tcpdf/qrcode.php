...
if (!class_exists('QRcode', false)) {
	...
	ted function writeFormatInformation($width, &$frame, $mask, $level) {
			$blacks = 0;
	...
	tected function encodeMode8($inputitem, $version) {
			$inputitem['bstream'] = array();
	...
	tected function appendBitstream($bitstream, $append) {
